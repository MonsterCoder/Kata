...
defmodule Solution_test do
  ...
  test "turn on 0,0 to 1,2" do
    assert parse_instruction(["turn","on","0,0","through","1,2"], [{0,0}, {4,4}]) == [{0,0}, {0,1}, {0,2}, {1,0}, {1,1},{1,2}, {4,4}]
  end
  ...
  test "toggle  1,1 to 1,2" do
    assert parse_instruction(["toggle","1,1","through","1,2"], [{0,0},{1,2},{4,4}]) == [{0,0},{1,1},{4,4}]
  end
